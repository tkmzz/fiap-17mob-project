...
4. O aplicativo deve oferecer uma tela para que o usuário se cadastre, enviando em seu cadastro uma foto de perfil, que deve ser obtida a partir da câmera do celular;
